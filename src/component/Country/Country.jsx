...
const Country = ({country, handleVisitedCountries}) => {
    ...
    return (
        <div className={`border-[2px] border-[#141414] rounded-[8px] px-[12px] py-[12px] ${visited ? 'bg-[#edfceb]' : 'bg-[#fff]'}`}>
            ...
            <button onClick={handleVisited} className='ml-3 mt-5 px-[20px] py-[10px] rounded-[4px] bg-[#3FBE53] text-[#fff] font-[700] cursor-pointer'>
